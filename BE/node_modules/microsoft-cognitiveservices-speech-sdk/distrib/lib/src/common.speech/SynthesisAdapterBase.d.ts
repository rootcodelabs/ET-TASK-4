import { ConnectionEvent, EventSource, IAudioDestination, IConnection, IDisposable, ServiceEvent } from "microsoft-cognitiveservices-speech-sdk/distrib/lib/src/common/Exports.js";
import { AudioOutputFormatImpl } from "microsoft-cognitiveservices-speech-sdk/distrib/lib/src/sdk/Audio/AudioOutputFormat.js";
import { CancellationErrorCode, CancellationReason, SpeechSynthesisBookmarkEventArgs, SpeechSynthesisResult, SpeechSynthesisVisemeEventArgs, SpeechSynthesisWordBoundaryEventArgs, Synthesizer } from "microsoft-cognitiveservices-speech-sdk/distrib/lib/src/sdk/Exports.js";
import { AgentConfig, ISynthesisConnectionFactory, ISynthesisMetadata, SynthesisContext, SynthesisTurn, SynthesizerConfig } from "microsoft-cognitiveservices-speech-sdk/distrib/lib/src/common.speech/Exports.js";
