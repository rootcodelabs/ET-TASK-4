import { DisfluencyMode } from "microsoft-cognitiveservices-speech-sdk/distrib/lib/src/common.speech/ServiceMessages/PhraseDetection/DisfluencyMode";
/**
 * The interactive punctuation mode.
 */
export declare enum InteractivePunctuationMode {
    None = "None",
    Implicit = "Implicit",
    Explicit = "Explicit",
