...
import { SpeechSynthesisBookmarkEventArgs, SpeechSynthesisResult, SpeechSynthesisVisemeEventArgs, SpeechSynthesisWordBoundaryEventArgs, SpeechSynthesizer } from "microsoft-cognitiveservices-speech-sdk/distrib/lib/src/sdk/Exports.js";
import { IAuthentication, ISynthesisConnectionFactory, SynthesisAdapterBase, SynthesizerConfig } from "microsoft-cognitiveservices-speech-sdk/distrib/lib/src/common.speech/Exports.js";
