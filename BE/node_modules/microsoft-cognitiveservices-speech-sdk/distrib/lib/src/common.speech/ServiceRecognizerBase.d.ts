import { ConnectionEvent, EventSource, IAudioSource, IAudioStreamNode, IConnection, IDisposable, ServiceEvent } from "microsoft-cognitiveservices-speech-sdk/distrib/lib/src/common/Exports.js";
import { CancellationErrorCode, CancellationReason, Recognizer, SpeechRecognitionResult } from "microsoft-cognitiveservices-speech-sdk/distrib/lib/src/sdk/Exports.js";
import { Callback } from "microsoft-cognitiveservices-speech-sdk/distrib/lib/src/sdk/Transcription/IConversation.js";
import { AgentConfig, DynamicGrammarBuilder, RequestSession, SpeechContext } from "microsoft-cognitiveservices-speech-sdk/distrib/lib/src/common.speech/Exports.js";
import { IAuthentication } from "microsoft-cognitiveservices-speech-sdk/distrib/lib/src/common.speech/IAuthentication.js";
import { IConnectionFactory } from "microsoft-cognitiveservices-speech-sdk/distrib/lib/src/common.speech/IConnectionFactory.js";
import { RecognizerConfig } from "microsoft-cognitiveservices-speech-sdk/distrib/lib/src/common.speech/RecognizerConfig.js";
import { SpeechConnectionMessage } from "microsoft-cognitiveservices-speech-sdk/distrib/lib/src/common.speech/SpeechConnectionMessage.Internal.js";
import { RecognitionMode } from "microsoft-cognitiveservices-speech-sdk/distrib/lib/src/common.speech/ServiceMessages/PhraseDetection/PhraseDetectionContext.js";
export declare abstract class ServiceRecognizerBase implements IDisposable {
    ...
    protected privExpectContentAssessmentResponse: boolean;
