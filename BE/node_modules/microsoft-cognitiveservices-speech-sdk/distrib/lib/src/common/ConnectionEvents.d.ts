import { ConnectionMessage } from "microsoft-cognitiveservices-speech-sdk/distrib/lib/src/common/ConnectionMessage.js";
import { IStringDictionary } from "microsoft-cognitiveservices-speech-sdk/distrib/lib/src/common/IDictionary.js";
import { EventType, PlatformEvent } from "microsoft-cognitiveservices-speech-sdk/distrib/lib/src/common/PlatformEvent.js";
...
export declare class ConnectionRedirectEvent extends ConnectionEvent {
    private privRedirectUrl;
    private privOriginalUrl?;
    private privContext?;
    constructor(connectionId: string, redirectUrl: string, originalUrl?: string, context?: string);
