import { PropertyCollection, SpeechTranslationConfig } from "microsoft-cognitiveservices-speech-sdk/distrib/lib/src/sdk/Exports.js";
import { IParticipant, IUser, TranscriptionParticipant } from "microsoft-cognitiveservices-speech-sdk/distrib/lib/src/sdk/Transcription/IParticipant.js";
export declare type Callback = (result?: any) => void;
/**
 * Manages meetings.
 */
