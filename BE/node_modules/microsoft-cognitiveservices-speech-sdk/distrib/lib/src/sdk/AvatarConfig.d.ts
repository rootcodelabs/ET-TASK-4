import { AvatarVideoFormat } from "microsoft-cognitiveservices-speech-sdk/distrib/lib/src/sdk/Exports.js";
/**
...
export declare class AvatarConfig {
    ...
    private privPhotoAvatarBaseModel;
     ...
     */
    get photoAvatarBaseModel(): string;
    /**
     * Sets the photo avatar base model name.
     */
    set photoAvatarBaseModel(value: string);
    /**
