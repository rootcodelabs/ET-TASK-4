...
import { OutputFormat, ProfanityOption, PropertyCollection, PropertyId, ServicePropertyChannel, SpeechSynthesisOutputFormat } from "microsoft-cognitiveservices-speech-sdk/distrib/lib/src/sdk/Exports.js";
/**
...
export declare abstract class SpeechConfig {
     ...
     */
    abstract get tokenCredential(): TokenCredential | undefined;
    /**
     ...
     * @returns {SpeechConfig} A speech factory instance.
     */
    static fromEndpoint(endpoint: URL, credential: KeyCredential | TokenCredential): SpeechConfig;
    /**
